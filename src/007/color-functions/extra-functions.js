...
// This is a single instruction, with multiple parts
console.log(colorName('rebeccapurple', '663399'));
// A)                 \__ arguments sent in __/
// B)       \_______ returned value __________/
// C)                is sent as an argument
// D)   \____________ returns undefined ______/



let description = colorName('darkorange', 'ff8c00')
