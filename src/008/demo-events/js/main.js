...
//     // Every HTML Element has a property called .classList which represents
//     // all of the CSS class names being applied to the image.
//     // The .classList has functions/methods to add/remove/toggle the presence
//     // of CSS class names.
// }
